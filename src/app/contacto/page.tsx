        ...
        <div className="relative min-h-[64svh] overflow-hidden">
          ...
          <div className="container-sar relative mt-24 flex min-h-[calc(64svh-6rem)] items-end">
            <Reveal className="max-w-4xl space-y-5 py-12 text-white sm:py-16 md:py-20">
              ...
              <p className="max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">{c.hero_subtitulo}</p>
            </Reveal>
          </div>
        </div>
      </section>
            ...
            <form className="mt-6 space-y-5">
              <div className="grid gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  <label htmlFor="nombre" className="label-premium">Nombre completo</label>
                  <input id="nombre" type="text" name="nombre" className="input-premium" required />
                </div>
                <div className="space-y-2">
                  <label htmlFor="telefono" className="label-premium">Telefono</label>
                  <input id="telefono" type="tel" name="telefono" className="input-premium" required />
                </div>
              </div>
              <div className="space-y-2">
                <label htmlFor="email" className="label-premium">Email</label>
                <input id="email" type="email" name="email" className="input-premium" required />
              </div>
              <div className="space-y-2">
                <label htmlFor="motivo" className="label-premium">Motivo de contacto</label>
                <select id="motivo" name="motivo" className="input-premium" required>
                  <option value="">Seleccionar motivo</option>
                  <option value="inversion">Inversion</option>
                  <option value="informacion-proyectos">Informacion de proyectos</option>
