    ...
    <>
      ...
      <section id="contacto" className="relative overflow-hidden section-white">
        ...
        <div className="container-sar relative section-padding">
          <Reveal
            delay={0.12}
            className="panel mx-auto max-w-4xl rounded-3xl border-brand/15 bg-[#eef2ff] p-6 shadow-[0_34px_100px_-60px_rgba(0,0,0,0.8)] transition-transform duration-300 hover:-translate-y-1 sm:p-8 md:p-14"
          >
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
              CONTACTANOS
            </h2>
